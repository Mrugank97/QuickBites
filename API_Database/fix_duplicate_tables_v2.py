"""
Script to fix duplicate tables in the cs432g11 database (Version 2)
...
def fix_duplicate_tables():
    ...
    try:
        ...
        # Create a view to show payments from CIMS G11_payments table
        cursor.execute("""
            ...
            SELECT 
                ...
                m.UserName as customer_name
            FROM 
                cs432cims.G11_payments p
            JOIN 
                orders o ON p.OrderID = o.order_id
            JOIN 
                cs432cims.members m ON o.member_id = m.ID
        """)
        logging.info("payment_details view created successfully")
